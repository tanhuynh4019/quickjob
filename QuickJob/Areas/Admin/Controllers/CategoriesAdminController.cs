...
namespace QuickJob.Areas.Admin.Controllers
{
    public class CategoriesAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "cate_id,cate_name,cate_view")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "cate_id,cate_name,cate_view")] Category category)
        {
            if (ModelState.IsValid)
            {
